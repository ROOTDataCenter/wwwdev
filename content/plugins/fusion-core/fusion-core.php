...
/**
 * OTF Regenerate Thumbnails ( BEST thumb downsizer for WP )
 */
include_once 'libs/otf_regen_thumbs.php';

/**
 * Avada Functions
 */
include_once 'libs/custom_functions.php';
include_once 'libs/avada-functions.php';

/**
 * Fusion Functions
 */
include_once 'libs/fusion-functions.php';
