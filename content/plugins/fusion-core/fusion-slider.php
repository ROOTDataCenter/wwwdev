	...
	class Fusion_Slider {
		...
		function slider_add_new_meta_fields() {
			...
			<div class="form-field">
				...
				<input type="text" name="term_meta[typo_sensitivity]" id="term_meta[typo_sensitivity]" value="0.6">
				<p class="description"><?php _e( 'IMPORTANT: you must have "Responsive Type" option enabled in theme options > typography for this to work.  Values below 1 decrease resizing, values above 1 increase sizing. ex: .6', 'fusion-core' ); ?></p>
			</div>
			<div class="form-field">
				...
				<p class="description"><?php _e( 'IMPORTANT: you must have "Responsive Type" option enabled in theme options > typography for this to work.  Mininum font factor is used to determine mininum font size for the slider. ex: 1.5', 'fusion-core' ); ?></p>
			</div>
		<?php
		}
