...
if ( ! class_exists( 'Fusion_Flickr_Widget' ) ) {
	...
	class Fusion_Flickr_Widget extends WP_Widget {
		...
		function form($instance)
		{
			...
			<p>
				<label for="<?php echo $this->get_field_id('screen_name'); ?>">Flickr ID(<a href="<?php echo $flickr_getid_url; ?>">Get your flickr ID</a>):</label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('api'); ?>">API key (Use default or get your own from <a href="<?php echo $flickr_apply_url; ?>">Flickr APP Garden</a>):</label>
